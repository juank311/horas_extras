          ...
          <div class="card">
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-md-3">
                <button type="button" class="btn btn-primary btn-xl pull-right w-100" data-toggle="modal" data-target="#modal-ingresar-nuevo-usuario">
                      ...
                      <div class="card-body">
                        <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control" name="phone" placeholder="Ingrese el Numero de Telefono">
                          </div>
                          <div class="form-group">
